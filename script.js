...
jQuery(function ($) {
    ...
    if (supportsAudio) {
        ...
        $.getJSON("https://5dd1894f15bbc2001448d28e.mockapi.io/playlist/", function(tracks){
            var index = 0,
            playing = false,
            buildPlaylist = $.each(tracks, function(key, value) {
                ...
                $('#plList').append('<li> \
                    <div class="plItem"> \
                        ...
                        <span class="plCover" > <img src='  + Cover  + ' width=30px height=30px > </span> \
                        <span class="plTitle">' + trackName + ' </span> \
                        <span class="plArtist">' + artist + ' </span> \
                    </div> \
                </li>');
            }),
            ...
            btnshuffle = $("#btnshuffle").on("click", function(){
                if ((index +  Math.floor(Math.random() * 6)) < trackCount ) {
